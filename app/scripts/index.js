...
var data = [
  {
		...
		"width": ["8vw", "calc(100vw - 30px)"],
		"height": ["8vw", "calc(100vw - 30px)"],
		"border-radius": ["0%", "100%"],
		"border-left": ["8vw solid #E01270", "48vw solid #545BD2"],
		"border-right": ["8vw solid #EC1A3B", "48vw solid #3A328E"],
		"border-top": ["8vw solid #EF4F7B", "48vw solid #0174B8"],
		"border-bottom": ["8vw solid #BD1A86", "48vw solid #1E4DA1"],
		"min-height": ["10%", "10%"],
		"margin-top": ["0", "0"],
	...
	},
	{
		...
		"box-shadow": [
			"inset 28vw 0 0 rgba(74,61,206, 0.2), inset 0 28vw 0 rgba(74,61,206, 0.2), inset -28vw 0 0 rgba(74,61,206, 0.2), inset 0 -28vw 0 rgba(74,61,206, 0.2)",
			"inset 33vw 0 0 rgba(224,18,112, 0.5), inset 0 33vw 0 rgba(84,91,210, 0.5), inset -33vw 0 0 rgba(33,252,221, 0.5), inset 0 -33vw 0 rgba(218,21,33, 0.5)"
		],
